...
int dfs_cut(int nach, int v, int N, int path_dlina, std::vector<std::vector<int>> arr);
...
void marshrutiki(int u, int** arr, std::vector<int> path, bool* versh, std::vector<std::vector<int>>& arrpath, int N);